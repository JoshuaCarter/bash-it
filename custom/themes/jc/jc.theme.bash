...
. "$BASH_IT/custom/themes/jc/jc.base.bash"
...
NPM_CHAR=${POWERLINE_NPM_CHAR:=""}
NPM_THEME_PROMPT_COLOR=${POWERLINE_NPM_COLOR:=23}
...
POWERLINE_PROMPT=${POWERLINE_PROMPT:="cwd user_info scm node npm aws_profile"}
